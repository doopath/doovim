...
call edge#highlight('Boolean', s:palette.cyan, s:palette.none)
call edge#highlight('Number', s:palette.cyan, s:palette.none)
call edge#highlight('Float', s:palette.cyan, s:palette.none)
